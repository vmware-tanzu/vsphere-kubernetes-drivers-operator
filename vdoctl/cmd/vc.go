...
//
//			vcIp := pkg.PromptGetInput(labels.vcIp, errors.New("invalid input"), pkg.IsIP)
//			cpi.vcIp = vcIp
//
...
//
//				dc := pkg.PromptGetInput("Datacenters", errors.New("unable to get the datacenters"), pkg.IsString)
//
...
//					//	cpi.insecure = true
//					//}
//					getVCIP(&cpi, labels, "Storage Provider")
//
...
//
//		if isCPIMultiVC {
//			csi.vcIp = pkg.PromptGetSelect(cpi.vsphereCloudConfigs, "Please select vcenter for configuring Storage Provider?")
...
//					netPerms = pkg.PromptGetInput("Do you want to configure another netpermissions (Y/N)", errors.New("invalid input"), pkg.IsString)
//
//					if netPerms == "Y" || netPerms == "y" {
//						continue
//					}
...
//	fmt.Printf("Please provide the VC_IP for configuring %s", driver)
//	vcIp := pkg.PromptGetInput(labels.vcIp, errors.New("unable to get the VC_IP"), pkg.IsIP)
//	cred.vcIp = vcIp
//
//	res := pkg.PromptGetInput("Do you want to establish a secure connection? (Y/N)", errors.New("invalid input"), pkg.IsString)
